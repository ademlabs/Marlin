...
#define STRING_CONFIG_H_AUTHOR "(arvind-d, CR-10S)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality 3D CR-10S
  // Command to use: M303 E-1 C8 S90
  // Below config is from some online code
